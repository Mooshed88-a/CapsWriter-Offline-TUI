...
以下为原项目 README，由于当前分支的修改，部分内容已不适用（如文档中提到“修改配置文件”的部分现应在 TUI 界面中修改），请自行判断。
...
2.  **下载解压**：下载 [Latest Release](https://github.com/Mooshed88-a/CapsWriter-Offline-TUI/releases/latest) 里的软件本体，再到 [Models Release](https://github.com/Mooshed88-a/CapsWriter-Offline-TUI/releases/tag/models) 下载模型压缩包，将模型解压，放入 `models` 文件夹中对应模型的文件夹里。
