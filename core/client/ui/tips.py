...
class TipsDisplay:
    ...
    def show_mic_tips() -> None:
        ...
        console.rule('[bold #d55252]CapsWriter-Offline-TUI[/]')
        console.print(f'\n版本：[bold green]{__version__}[/]')

        markdown = f'''

项目地址：https://github.com/Mooshed88-a/CapsWriter-Offline-TUI

**CapsWriter-Offline-TUI** 是一个专为 Windows 打造的**完全离线**语音输入工具。
