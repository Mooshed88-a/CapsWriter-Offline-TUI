# coding: utf-8
"""
CapsWriter-Offline-TUI 兼容服务端门面类 (Facade)
...
class CapsWriterServer:
    ...
    def _print_banner(self):
        """打印启动信息"""
        console.line(2)
        console.rule('[bold #d55252]CapsWriter-Offline-TUI 兼容服务端[/]'); console.line()
        console.print(f'版本：[bold green]{self.version}[/]', end='\n\n')
        console.print(f'项目地址：[cyan underline]https://github.com/Mooshed88-a/CapsWriter-Offline-TUI', end='\n\n')
